...
import io.valkey.Protocol.ClusterKeyword;
import io.valkey.Protocol.Command;
import io.valkey.Protocol.Keyword;
import io.valkey.Protocol.SentinelKeyword;
...
import io.valkey.commands.ControlBinaryCommands;
import io.valkey.commands.ControlCommands;
import io.valkey.commands.DatabaseCommands;
import io.valkey.commands.GenericControlCommands;
import io.valkey.commands.JedisBinaryCommands;
import io.valkey.commands.JedisCommands;
import io.valkey.commands.ModuleCommands;
import io.valkey.commands.ProtocolCommand;
import io.valkey.commands.SentinelCommands;
import io.valkey.commands.ServerCommands;
...
//    if (connection.isInMulti()) {
  ...
  public String select(final int index) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.SELECT, Protocol.toByteArray(index));
  ...
  public String swapDB(final int index1, final int index2) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.SWAPDB, Protocol.toByteArray(index1), Protocol.toByteArray(index2));
    return connection.getStatusCodeReply();
  }
  ...
  public String flushDB(FlushMode flushMode) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.FLUSHDB, flushMode.getRaw());
    return connection.getStatusCodeReply();
  }
  ...
  public String flushAll(FlushMode flushMode) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.FLUSHALL, flushMode.getRaw());
    return connection.getStatusCodeReply();
  }
  ...
  public long dbSize() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.DBSIZE);
  ...
  public long move(final byte[] key, final int dbIndex) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.MOVE, key, Protocol.toByteArray(dbIndex));
    return connection.getIntegerReply();
  }
...
//    return connection.getStatusCodeReply();
  ...
  public String bgsave() {
    connection.sendCommand(Command.BGSAVE);
    return connection.getStatusCodeReply();
  }

  @Override
  public String bgsaveSchedule() {
    connection.sendCommand(Command.BGSAVE, Keyword.SCHEDULE);
    return connection.getStatusCodeReply();
  }
  ...
  public String bgrewriteaof() {
    connection.sendCommand(Command.BGREWRITEAOF);
    return connection.getStatusCodeReply();
  }
  ...
  public long lastsave() {
    connection.sendCommand(Command.LASTSAVE);
    return connection.getIntegerReply();
  }
  ...
  public void shutdown() throws JedisException {
    connection.sendCommand(Command.SHUTDOWN);
    try {
  ...
  public void shutdown(ShutdownParams shutdownParams) throws JedisException {
    connection.sendCommand(new CommandArguments(Command.SHUTDOWN).addParams(shutdownParams));
    try {
      throw new JedisException(connection.getStatusCodeReply());
    } catch (JedisConnectionException jce) {
      // expected
  ...
  public String shutdownAbort() {
    connection.sendCommand(Command.SHUTDOWN, Keyword.ABORT);
    return connection.getStatusCodeReply();
  }
...
//    connection.monitor();
  ...
  public String slaveof(final String host, final int port) {
    connection.sendCommand(Command.SLAVEOF, encode(host), Protocol.toByteArray(port));
    return connection.getStatusCodeReply();
  }
  ...
  public String slaveofNoOne() {
    connection.sendCommand(Command.SLAVEOF, Keyword.NO.getRaw(), Keyword.ONE.getRaw());
    return connection.getStatusCodeReply();
  }

  @Override
  public String replicaof(final String host, final int port) {
    connection.sendCommand(Command.REPLICAOF, encode(host), Protocol.toByteArray(port));
    return connection.getStatusCodeReply();
  }

  @Override
  public String replicaofNoOne() {
    connection.sendCommand(Command.REPLICAOF, Keyword.NO.getRaw(), Keyword.ONE.getRaw());
    return connection.getStatusCodeReply();
  }
  ...
  public List<Object> roleBinary() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ROLE);
  ...
  public byte[] echo(final byte[] string) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ECHO, string);
    return connection.getBinaryBulkReply();
  }
  ...
  public String scriptFlush() {
    connection.sendCommand(Command.SCRIPT, Keyword.FLUSH);
    return connection.getStatusCodeReply();
  }

  @Override
  public String scriptFlush(final FlushMode flushMode) {
    connection.sendCommand(Command.SCRIPT, Keyword.FLUSH.getRaw(), flushMode.getRaw());
    return connection.getStatusCodeReply();
  }
  ...
  public List<Boolean> scriptExists(final byte[]... sha1) {
    connection.sendCommand(Command.SCRIPT, joinParameters(Keyword.EXISTS.getRaw(), sha1));
    return BuilderFactory.BOOLEAN_LIST.build(connection.getOne());
  }

  @Override
  public byte[] scriptLoad(final byte[] script) {
    connection.sendCommand(Command.SCRIPT, Keyword.LOAD.getRaw(), script);
    return connection.getBinaryBulkReply();
  }
  ...
  public long slowlogLen() {
    connection.sendCommand(Command.SLOWLOG, Keyword.LEN);
    return connection.getIntegerReply();
  }

  @Override
  public List<Object> slowlogGetBinary() {
    connection.sendCommand(Command.SLOWLOG, Keyword.GET);
    return connection.getObjectMultiBulkReply();
  }

  @Override
  public List<Object> slowlogGetBinary(final long entries) {
    connection.sendCommand(Command.SLOWLOG, Keyword.GET.getRaw(), Protocol.toByteArray(entries));
    return connection.getObjectMultiBulkReply();
  }

  @Override
  public Long objectRefcount(final byte[] key) {
    connection.sendCommand(Command.OBJECT, Keyword.REFCOUNT.getRaw(), key);
    return connection.getIntegerReply();
  }

  @Override
  public byte[] objectEncoding(final byte[] key) {
    connection.sendCommand(Command.OBJECT, Keyword.ENCODING.getRaw(), key);
    return connection.getBinaryBulkReply();
  }

  @Override
  public Long objectIdletime(final byte[] key) {
    connection.sendCommand(Command.OBJECT, Keyword.IDLETIME.getRaw(), key);
    return connection.getIntegerReply();
  }

  @Override
  public List<byte[]> objectHelpBinary() {
    connection.sendCommand(Command.OBJECT, Keyword.HELP);
    return connection.getBinaryMultiBulkReply();
  }

  @Override
  public Long objectFreq(final byte[] key) {
    connection.sendCommand(Command.OBJECT, Keyword.FREQ.getRaw(), key);
    return connection.getIntegerReply();
  }
  ...
  public byte[] memoryDoctorBinary() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.MEMORY, Keyword.DOCTOR);
    return connection.getBinaryBulkReply();
  }
  ...
  public Long memoryUsage(final byte[] key) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.MEMORY, Keyword.USAGE.getRaw(), key);
    return connection.getIntegerReply();
  }
  ...
  public Long memoryUsage(final byte[] key, final int samples) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.MEMORY, Keyword.USAGE.getRaw(), key, Keyword.SAMPLES.getRaw(), Protocol.toByteArray(samples));
    return connection.getIntegerReply();
  }
  ...
  public String failoverAbort() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.FAILOVER, Keyword.ABORT);
    return connection.getStatusCodeReply();
  }
  ...
  public byte[] aclWhoAmIBinary() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, Keyword.WHOAMI);
    return connection.getBinaryBulkReply();
  }
  ...
  public byte[] aclGenPassBinary() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, Keyword.GENPASS);
    return connection.getBinaryBulkReply();
  }
  ...
  public byte[] aclGenPassBinary(int bits) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, Keyword.GENPASS.getRaw(), Protocol.toByteArray(bits));
    return connection.getBinaryBulkReply();
  }
  ...
  public List<byte[]> aclListBinary() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, Keyword.LIST);
    return connection.getBinaryMultiBulkReply();
  }
  ...
  public List<byte[]> aclUsersBinary() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, Keyword.USERS);
    return connection.getBinaryMultiBulkReply();
  }
  ...
  public AccessControlUser aclGetUser(byte[] name) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, Keyword.GETUSER.getRaw(), name);
  ...
  public String aclSetUser(byte[] name) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, Keyword.SETUSER.getRaw(), name);
    return connection.getStatusCodeReply();
  }
  ...
  public String aclSetUser(byte[] name, byte[]... rules) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, joinParameters(Keyword.SETUSER.getRaw(), name, rules));
    return connection.getStatusCodeReply();
  }
  ...
  public long aclDelUser(byte[]... names) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, joinParameters(Keyword.DELUSER.getRaw(), names));
    return connection.getIntegerReply();
  }
  ...
  public List<byte[]> aclCatBinary() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, Keyword.CAT);
    return connection.getBinaryMultiBulkReply();
  }
  ...
  public List<byte[]> aclCat(byte[] category) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, Keyword.CAT.getRaw(), category);
    return connection.getBinaryMultiBulkReply();
  }
  ...
  public List<byte[]> aclLogBinary() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, Keyword.LOG);
    return connection.getBinaryMultiBulkReply();
  }
  ...
  public List<byte[]> aclLogBinary(int limit) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, Keyword.LOG.getRaw(), Protocol.toByteArray(limit));
    return connection.getBinaryMultiBulkReply();
  }
  ...
  public String aclLogReset() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, Keyword.LOG.getRaw(), Keyword.RESET.getRaw());
    return connection.getStatusCodeReply();
  }
  ...
  public String clientKill(final byte[] ipPort) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, Keyword.KILL.getRaw(), ipPort);
  ...
  public long clientKill(ClientKillParams params) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(new CommandArguments(Command.CLIENT).add(Keyword.KILL).addParams(params));
  ...
  public byte[] clientGetnameBinary() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, Keyword.GETNAME);
    return connection.getBinaryBulkReply();
  }
  ...
  public byte[] clientListBinary() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, Keyword.LIST);
    return connection.getBinaryBulkReply();
  }
  ...
  public byte[] clientListBinary(ClientType type) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, Keyword.LIST.getRaw(), type.getRaw());
    return connection.getBinaryBulkReply();
  }
  ...
  public byte[] clientListBinary(final long... clientIds) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, clientListParams(clientIds));
    return connection.getBinaryBulkReply();
  }
  ...
  public byte[] clientInfoBinary() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, Keyword.INFO);
    return connection.getBinaryBulkReply();
  }
  ...
  public String clientSetInfo(ClientAttributeOption attr, byte[] value) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, Keyword.SETINFO.getRaw(), attr.getRaw(), value);
    return connection.getStatusCodeReply();
  }
  ...
  public String clientSetname(final byte[] name) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, Keyword.SETNAME.getRaw(), name);
    return connection.getBulkReply();
  }
  ...
  public long clientId() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, Keyword.ID);
    return connection.getIntegerReply();
  }
  ...
  public long clientUnblock(final long clientId) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, Keyword.UNBLOCK.getRaw(), Protocol.toByteArray(clientId));
    return connection.getIntegerReply();
  }
  ...
  public long clientUnblock(final long clientId, final UnblockType unblockType) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, Keyword.UNBLOCK.getRaw(), Protocol.toByteArray(clientId), unblockType.getRaw());
    return connection.getIntegerReply();
  }
  ...
  public String clientPause(final long timeout) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, Keyword.PAUSE.getRaw(), Protocol.toByteArray(timeout));
    return connection.getBulkReply();
  }
  ...
  public String clientPause(final long timeout, final ClientPauseMode mode) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, Keyword.PAUSE.getRaw(), Protocol.toByteArray(timeout), mode.getRaw());
    return connection.getBulkReply();
  }
  ...
  public String clientUnpause() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, Keyword.UNPAUSE);
    return connection.getBulkReply();
  }
  ...
  public String clientNoEvictOn() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, "NO-EVICT", "ON");
    return connection.getBulkReply();
  }
  ...
  public String clientNoEvictOff() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, "NO-EVICT", "OFF");
    return connection.getBulkReply();
  }
  ...
  public String clientNoTouchOn() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, "NO-TOUCH", "ON");
    return connection.getStatusCodeReply();
  }
  ...
  public String clientNoTouchOff() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, "NO-TOUCH", "OFF");
    return connection.getStatusCodeReply();
  }
  ...
  public TrackingInfo clientTrackingInfo() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, "TRACKINGINFO");
  ...
  public long waitReplicas(final int replicas, final long timeout) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.WAIT, Protocol.toByteArray(replicas), Protocol.toByteArray(timeout));
    return connection.getIntegerReply();
  }
  ...
  public KeyValue<Long, Long> waitAOF(long numLocal, long numReplicas, long timeout) {
    ...
    connection.sendCommand(
        Command.WAITAOF, Protocol.toByteArray(numLocal), Protocol.toByteArray(numReplicas), Protocol.toByteArray(timeout));
  ...
  public long move(final String key, final int dbIndex) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.MOVE, encode(key), Protocol.toByteArray(dbIndex));
    return connection.getIntegerReply();
  }
...
//    return connection.getStatusCodeReply();
  ...
  public long publish(final String channel, final String message) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.PUBLISH, channel, message);
    return connection.getIntegerReply();
  }
  ...
  public List<String> pubsubChannels() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.PUBSUB, Keyword.CHANNELS);
    return connection.getMultiBulkReply();
  }

  public List<String> pubsubChannels(final String pattern) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.PUBSUB, Keyword.CHANNELS.name(), pattern);
    return connection.getMultiBulkReply();
  }

  public Long pubsubNumPat() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.PUBSUB, Keyword.NUMPAT);
    return connection.getIntegerReply();
  }

  public Map<String, Long> pubsubNumSub(String... channels) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.PUBSUB, joinParameters(Keyword.NUMSUB.name(), channels));
    return BuilderFactory.PUBSUB_NUMSUB_MAP.build(connection.getOne());
  }

  public List<String> pubsubShardChannels() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.PUBSUB, Keyword.SHARDCHANNELS);
    return connection.getMultiBulkReply();
  }

  public List<String> pubsubShardChannels(final String pattern) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.PUBSUB, Keyword.SHARDCHANNELS.name(), pattern);
    return connection.getMultiBulkReply();
  }

  public Map<String, Long> pubsubShardNumSub(String... channels) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.PUBSUB, joinParameters(Keyword.SHARDNUMSUB.name(), channels));
    return BuilderFactory.PUBSUB_NUMSUB_MAP.build(connection.getOne());
  }
  ...
  public List<Boolean> scriptExists(final String... sha1) {
    connection.sendCommand(Command.SCRIPT, joinParameters(Keyword.EXISTS.name(), sha1));
    return BuilderFactory.BOOLEAN_LIST.build(connection.getOne());
  }

  @Override
  public String scriptLoad(final String script) {
    connection.sendCommand(Command.SCRIPT, Keyword.LOAD.name(), script);
    return connection.getBulkReply();
  }
  ...
  public Long objectRefcount(final String key) {
    connection.sendCommand(Command.OBJECT, Keyword.REFCOUNT.name(), key);
    return connection.getIntegerReply();
  }

  @Override
  public String objectEncoding(final String key) {
    connection.sendCommand(Command.OBJECT, Keyword.ENCODING.name(), key);
    return connection.getBulkReply();
  }

  @Override
  public Long objectIdletime(final String key) {
    connection.sendCommand(Command.OBJECT, Keyword.IDLETIME.name(), key);
    return connection.getIntegerReply();
  }
  ...
  public Long objectFreq(final String key) {
    connection.sendCommand(Command.OBJECT, Keyword.FREQ.name(), key);
    return connection.getIntegerReply();
  }
  ...
  public long commandCount() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.COMMAND, Keyword.COUNT);
    return connection.getIntegerReply();
  }

  public Map<String, CommandDocument> commandDocs(String... commands) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.COMMAND, joinParameters(Keyword.DOCS.name(), commands));
    return BuilderFactory.COMMAND_DOCS_RESPONSE.build(connection.getOne());
  }

  public List<String> commandGetKeys(String... command) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.COMMAND, joinParameters(Keyword.GETKEYS.name(), command));
  ...
  public List<KeyValue<String, List<String>>> commandGetKeysAndFlags(String... command) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.COMMAND, joinParameters(Keyword.GETKEYSANDFLAGS.name(), command));
  ...
  public Map<String, CommandInfo> commandInfo(String... commands) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.COMMAND, joinParameters(Keyword.INFO.name(), commands));
    return BuilderFactory.COMMAND_INFO_RESPONSE.build(connection.getOne());
  }

  public List<String> commandList() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.COMMAND, Keyword.LIST);
    return BuilderFactory.STRING_LIST.build(connection.getOne());
  }

  public List<String> commandListFilterBy(CommandListFilterByParams filterByParams) {
    checkIsInMultiOrPipeline();
    CommandArguments args = new CommandArguments(Command.COMMAND).add(Keyword.LIST).addParams(filterByParams);
    connection.sendCommand(args);
    return BuilderFactory.STRING_LIST.build(connection.getOne());
  }
  ...
  public String sentinelMyId() {
    connection.sendCommand(Command.SENTINEL, SentinelKeyword.MYID);
    return connection.getBulkReply();
  }
  ...
  public List<Map<String, String>> sentinelMasters() {
    connection.sendCommand(Command.SENTINEL, SentinelKeyword.MASTERS);
  ...
  public Map<String, String> sentinelMaster(String masterName) {
    connection.sendCommand(Command.SENTINEL, SentinelKeyword.MASTER.name(), masterName);
    return BuilderFactory.STRING_MAP.build(connection.getOne());
  }

  @Override
  public List<Map<String, String>> sentinelSentinels(String masterName) {
    connection.sendCommand(Command.SENTINEL, SentinelKeyword.SENTINELS.name(), masterName);
    return connection.getObjectMultiBulkReply().stream()
        .map(BuilderFactory.STRING_MAP::build).collect(Collectors.toList());
  }
  ...
  public List<String> sentinelGetMasterAddrByName(String masterName) {
    connection.sendCommand(Command.SENTINEL, SentinelKeyword.GET_MASTER_ADDR_BY_NAME.getRaw(), encode(masterName));
    return connection.getMultiBulkReply();
  }
  ...
  public Long sentinelReset(String pattern) {
    connection.sendCommand(Command.SENTINEL, SentinelKeyword.RESET.name(), pattern);
    return connection.getIntegerReply();
  }
  ...
  public List<Map<String, String>> sentinelSlaves(String masterName) {
    connection.sendCommand(Command.SENTINEL, SentinelKeyword.SLAVES.name(), masterName);
    return connection.getObjectMultiBulkReply().stream()
        .map(BuilderFactory.STRING_MAP::build).collect(Collectors.toList());
  }
  ...
  public List<Map<String, String>> sentinelReplicas(String masterName) {
    connection.sendCommand(Command.SENTINEL, SentinelKeyword.REPLICAS.name(), masterName);
    return connection.getObjectMultiBulkReply().stream()
        .map(BuilderFactory.STRING_MAP::build).collect(Collectors.toList());
  }
  ...
  public String sentinelFailover(String masterName) {
    connection.sendCommand(Command.SENTINEL, SentinelKeyword.FAILOVER.name(), masterName);
    return connection.getStatusCodeReply();
  }

  @Override
  public String sentinelMonitor(String masterName, String ip, int port, int quorum) {
    CommandArguments args = new CommandArguments(Command.SENTINEL).add(SentinelKeyword.MONITOR)
  ...
  public String sentinelRemove(String masterName) {
    connection.sendCommand(Command.SENTINEL, SentinelKeyword.REMOVE.name(), masterName);
    return connection.getStatusCodeReply();
  }

  @Override
  public String sentinelSet(String masterName, Map<String, String> parameterMap) {
    CommandArguments args = new CommandArguments(Command.SENTINEL).add(SentinelKeyword.SET).add(masterName);
  ...
  public String aclSetUser(final String name) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, Keyword.SETUSER.name(), name);
    return connection.getStatusCodeReply();
  }
  ...
  public String aclSetUser(String name, String... rules) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, joinParameters(Keyword.SETUSER.name(), name, rules));
    return connection.getStatusCodeReply();
  }
  ...
  public long aclDelUser(final String... names) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, joinParameters(Keyword.DELUSER.name(), names));
    return connection.getIntegerReply();
  }
  ...
  public AccessControlUser aclGetUser(final String name) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, Keyword.GETUSER.name(), name);
  ...
  public List<String> aclCat(String category) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, Keyword.CAT.name(), category);
    return BuilderFactory.STRING_LIST.build(connection.getOne());
  }
  ...
  public String aclLoad() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, Keyword.LOAD);
    return connection.getStatusCodeReply();
  }
  ...
  public String aclSave() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.ACL, Keyword.SAVE);
    return connection.getStatusCodeReply();
  }
  ...
  public String aclDryRun(String username, String command, String... args) {
    ...
    allArgs[0] = Keyword.DRYRUN.name();
    allArgs[1] = username;
    allArgs[2] = command;
    System.arraycopy(args, 0, allArgs, 3, args.length);
    connection.sendCommand(Command.ACL, allArgs);
    return connection.getBulkReply();
  }
  ...
  public String aclDryRun(String username, CommandArguments commandArgs) {
    checkIsInMultiOrPipeline();
    CommandArguments allArgs = new CommandArguments(Command.ACL).add(Keyword.DRYRUN).add(username);
  ...
  public byte[] aclDryRunBinary(byte[] username, byte[] command, byte[]... args) {
    ...
    allArgs[0] = Keyword.DRYRUN.getRaw();
    allArgs[1] = username;
    allArgs[2] = command;
    System.arraycopy(args, 0, allArgs, 3, args.length);
    connection.sendCommand(Command.ACL, allArgs);
  ...
  public String clientKill(final String ipPort) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, Keyword.KILL.name(), ipPort);
    return connection.getStatusCodeReply();
  }
  ...
  public String clientList(ClientType type) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, Keyword.LIST.getRaw(), Keyword.TYPE.getRaw(), type.getRaw());
    return connection.getBulkReply();
  }
  ...
  public String clientSetInfo(ClientAttributeOption attr, String value) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, Keyword.SETINFO.getRaw(), attr.getRaw(), encode(value));
    return connection.getStatusCodeReply();
  }
  ...
  public String clientSetname(final String name) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLIENT, Keyword.SETNAME.name(), name);
    return connection.getStatusCodeReply();
  }
  ...
  public String readonly() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.READONLY);
    return connection.getStatusCodeReply();
  }
  ...
  public String readwrite() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.READWRITE);
    return connection.getStatusCodeReply();
  }
  ...
  public String clusterNodes() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.NODES);
    return connection.getBulkReply();
  }
  ...
  public String clusterMeet(final String ip, final int port) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.MEET.name(), ip, Integer.toString(port));
    return connection.getStatusCodeReply();
  }
  ...
  public String clusterReset() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.RESET);
    return connection.getStatusCodeReply();
  }
  ...
  public String clusterReset(final ClusterResetType resetType) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.RESET.getRaw(), resetType.getRaw());
    return connection.getStatusCodeReply();
  }
  ...
  public String clusterAddSlots(final int... slots) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, joinParameters(ClusterKeyword.ADDSLOTS.getRaw(), joinParameters(slots)));
    return connection.getStatusCodeReply();
  }
  ...
  public String clusterDelSlots(final int... slots) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, joinParameters(ClusterKeyword.DELSLOTS.getRaw(), joinParameters(slots)));
    return connection.getStatusCodeReply();
  }
  ...
  public String clusterInfo() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.INFO);
    return connection.getStatusCodeReply();
  }
  ...
  public List<String> clusterGetKeysInSlot(final int slot, final int count) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(
        Command.CLUSTER, ClusterKeyword.GETKEYSINSLOT.getRaw(), Protocol.toByteArray(slot), Protocol.toByteArray(count));
    return connection.getMultiBulkReply();
  }
  ...
  public String clusterSetSlotNode(final int slot, final String nodeId) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.SETSLOT.getRaw(), Protocol.toByteArray(slot), ClusterKeyword.NODE.getRaw(), encode(nodeId));
    return connection.getStatusCodeReply();
  }
  ...
  public String clusterSetSlotMigrating(final int slot, final String nodeId) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.SETSLOT.getRaw(), Protocol.toByteArray(slot), ClusterKeyword.MIGRATING.getRaw(), encode(nodeId));
    return connection.getStatusCodeReply();
  }
  ...
  public String clusterSetSlotImporting(final int slot, final String nodeId) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.SETSLOT.getRaw(), Protocol.toByteArray(slot), ClusterKeyword.IMPORTING.getRaw(), encode(nodeId));
    return connection.getStatusCodeReply();
  }
  ...
  public String clusterSetSlotStable(final int slot) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.SETSLOT.getRaw(), Protocol.toByteArray(slot), ClusterKeyword.STABLE.getRaw());
    return connection.getStatusCodeReply();
  }
  ...
  public String clusterForget(final String nodeId) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.FORGET.name(), nodeId);
    return connection.getStatusCodeReply();
  }
  ...
  public String clusterFlushSlots() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.FLUSHSLOTS);
    return connection.getStatusCodeReply();
  }
  ...
  public long clusterKeySlot(final String key) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.KEYSLOT.name(), key);
    return connection.getIntegerReply();
  }
  ...
  public long clusterCountFailureReports(final String nodeId) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, "COUNT-FAILURE-REPORTS",  nodeId);
    return connection.getIntegerReply();
  }
  ...
  public long clusterCountKeysInSlot(final int slot) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.COUNTKEYSINSLOT.getRaw(), Protocol.toByteArray(slot));
    return connection.getIntegerReply();
  }
  ...
  public String clusterSaveConfig() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.SAVECONFIG);
    return connection.getStatusCodeReply();
  }
  ...
  public String clusterSetConfigEpoch(long configEpoch) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, "SET-CONFIG-EPOCH", Long.toString(configEpoch));
    return connection.getStatusCodeReply();
  }
  ...
  public String clusterBumpEpoch() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.BUMPEPOCH);
    return connection.getBulkReply();
  }
  ...
  public String clusterReplicate(final String nodeId) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.REPLICATE.name(), nodeId);
    return connection.getStatusCodeReply();
  }
  ...
  public List<String> clusterSlaves(final String nodeId) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.SLAVES.name(), nodeId);
    return connection.getMultiBulkReply();
  }
  ...
  public List<String> clusterReplicas(final String nodeId) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.REPLICAS.name(), nodeId);
    return connection.getMultiBulkReply();
  }
  ...
  public String clusterFailover() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.FAILOVER);
    return connection.getStatusCodeReply();
  }
  ...
  public String clusterFailover(ClusterFailoverOption failoverOption) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.FAILOVER.getRaw(), failoverOption.getRaw());
    return connection.getStatusCodeReply();
  }
  ...
  public List<Object> clusterSlots() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.SLOTS);
    return connection.getObjectMultiBulkReply();
  }
  ...
  public List<ClusterShardInfo> clusterShards() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.SHARDS);
  ...
  public String clusterMyId() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.MYID);
    return connection.getBulkReply();
  }
  ...
  public String clusterMyShardId() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.MYSHARDID);
    return connection.getBulkReply();
  }
  ...
  public List<Map<String, Object>> clusterLinks() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER, ClusterKeyword.LINKS);
    return connection.getObjectMultiBulkReply().stream()
  ...
  public String clusterAddSlotsRange(int... ranges) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.CLUSTER,
  ...
  public String moduleLoad(final String path) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.MODULE, Keyword.LOAD.name(), path);
    return connection.getStatusCodeReply();
  }
  ...
  public String moduleLoad(String path, String... args) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.MODULE, joinParameters(Keyword.LOAD.name(), path, args));
    return connection.getStatusCodeReply();
  }
  ...
  public String moduleLoadEx(String path, ModuleLoadExParams params) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(new CommandArguments(Command.MODULE).add(Keyword.LOADEX).add(path)
        .addParams(params));
    return connection.getStatusCodeReply();
  }
  ...
  public String moduleUnload(final String name) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.MODULE, Keyword.UNLOAD.name(), name);
    return connection.getStatusCodeReply();
  }
  ...
  public List<Module> moduleList() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.MODULE, Keyword.LIST);
  ...
  public Long memoryUsage(final String key) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.MEMORY, Keyword.USAGE.name(), key);
    return connection.getIntegerReply();
  }
  ...
  public Long memoryUsage(final String key, final int samples) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(
        Command.MEMORY, Keyword.USAGE.getRaw(), encode(key), Keyword.SAMPLES.getRaw(), Protocol.toByteArray(samples));
    return connection.getIntegerReply();
  }
  ...
  public String memoryPurge() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.MEMORY, Keyword.PURGE);
    return connection.getBulkReply();
  }
  ...
  public Map<String, Object> memoryStats() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.MEMORY, Keyword.STATS);
  ...
  public String lolwut() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.LOLWUT);
    return connection.getBulkReply();
  }
  ...
  public String lolwut(LolwutParams lolwutParams) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(new CommandArguments(Command.LOLWUT).addParams(lolwutParams));
    return connection.getBulkReply();
  }
  ...
  public String latencyDoctor() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.LATENCY, Keyword.DOCTOR);
    return connection.getBulkReply();
  }

  public Map<String, LatencyLatestInfo> latencyLatest() {
    checkIsInMultiOrPipeline();
    connection.sendCommand(Command.LATENCY, Keyword.LATEST);
  ...
  public List<LatencyHistoryInfo> latencyHistory(LatencyEvent event) {
    checkIsInMultiOrPipeline();
    connection.sendCommand(new CommandArguments(Command.LATENCY).add(Keyword.HISTORY).add(event));
    return BuilderFactory.LATENCY_HISTORY_RESPONSE.build(connection.getOne());
  }

  public long latencyReset(LatencyEvent... events) {
    checkIsInMultiOrPipeline();
    CommandArguments arguments = new CommandArguments(Command.LATENCY).add(Keyword.RESET);
