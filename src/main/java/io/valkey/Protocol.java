...
import io.valkey.exceptions.JedisAskDataException;
import io.valkey.exceptions.JedisBusyException;
import io.valkey.exceptions.JedisClusterException;
...
import io.valkey.exceptions.*;
import io.valkey.args.Rawable;
import io.valkey.commands.ProtocolCommand;
import io.valkey.util.KeyValue;
import io.valkey.util.RedisInputStream;
import io.valkey.util.RedisOutputStream;
...
//  }
  ...
  public static enum Command implements ProtocolCommand {
    ...
    STRLEN, APPEND, SUBSTR, DELIFEQ,// <-- string
  ...
  public static enum Keyword implements Rawable {
    ...
    RESETSTAT, REWRITE, RESET, FLUSH, EXISTS, LOAD, LEN, HELP, SCHEDULE, CANCEL, MATCH, COUNT, TYPE, KEYS,
    ...
    CHANNELS, NUMPAT, NUMSUB, SHARDCHANNELS, SHARDNUMSUB, NOVALUES, MAXAGE, CAPA, IFEQ;
